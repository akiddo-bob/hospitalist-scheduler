...
Location: `output/v1/report_1.html` through `report_5.html` (and `output/v2/` for engine v2)
...
Generated by: `.venv/bin/python3 -m analysis.generate_block3_report`

Location: `output/block3_validation_report.html`

Validates the manually-created Amion Block 3 schedule against 12 checks covering site eligibility, demand, distribution, capacity, consecutive stretches, availability, conflict pairs, and more.

For full documentation on what each check does, how to interpret the heatmap, and common review scenarios, see **[Block 3 Validation](block3-validation.md)**.
