#!/usr/bin/env python3
"""
HTML Report Generator for Block Schedule Engine v1.
...
<h1>Block 3 Schedule Report (Engine v1)</h1>
...
<p class="subtitle">Engine v1 &mdash; {block_start.strftime('%B %d')} to {block_end.strftime('%B %d, %Y')}</p>
